...
import { cacheCipher } from '@config/admin/setting/encryptionSetting';
...
export interface IWebStorage {
  set: (k: string, value: StorageValue, expire?: Nullable<number>) => void;
  get: (k: string, def?: Nullable<StorageValue>) => StorageValue;
...
export const createStorage = ({
  ...
  timeout = null,
  hasEncrypt = true,
}: Partial<CreateStorageParams> = {}): IWebStorage => {
